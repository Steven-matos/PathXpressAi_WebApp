    ...
    <div className="bg-white">
      ...
      <section aria-label="Main product introduction">
        <div className="relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto min-h-[80vh] px-4 sm:px-6 lg:px-8 
                          flex flex-col items-center justify-center 
                          py-16 sm:py-24 md:py-32"> {/* Adjusted padding for mobile */}
            <div className="w-full max-w-4xl"> {/* Added max-width container */}
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-white 
                             [text-shadow:_0_1px_12px_rgb(0_0_0_/_40%)] mb-4"> {/* Responsive font sizes */}
                {t("heroTitle")}
              </h1>
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-accent 
      ...
      <div className="relative isolate overflow-hidden bg-white py-12 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="isolate mx-auto mt-10 sm:mt-16 
                ...
                <ul role="list" className="mt-8 space-y-3 text-sm leading-6 text-gray-600">
                  {plan.featuresKeys.map((key) => (
                    <li key={key} className="flex gap-x-3">
                      <svg
                        className={`h-6 w-5 flex-none ${plan.popular ? 'text-accent' : 'text-primary'}`}
                        viewBox="0 0 20 20"
                        fill="currentColor"
                        aria-hidden="true"
                      >
          ...
          <div className="mt-16 flex flex-col gap-16 sm:gap-y-20 lg:flex-row">
            <form className="lg:flex-1">
              <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                <div>
                  <label htmlFor="firstName" className="block text-sm font-semibold leading-6 text-primary">
                    {t("firstName")}
                  </label>
                ...
                <div>
                  <label htmlFor="lastName" className="block text-sm font-semibold leading-6 text-primary">
                    {t("lastName")}
                  </label>
                  <div className="mt-2.5">
                    <input
